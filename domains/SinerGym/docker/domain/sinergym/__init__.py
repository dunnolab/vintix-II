...
from .utils.common import convert_conf_to_env_parameters
...
register(
    id='Eplus-demo-v1',
    entry_point='domain.sinergym.envs:EplusEnv',
    kwargs={
...
conf_files = []
configuration_path = os.path.join(os.path.dirname(__file__), 'data/default_configuration')
